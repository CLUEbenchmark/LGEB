...
def main():
    ...
    parser.add_argument("--pytorch_pretrained_bert_cache", default=None, type=str,
                        help="The cache dir of pytorch pretrained bert.")
    ...
    for model_recover_path in glob.glob(args.model_recover_path.strip()):
        ...
        print(args.pytorch_pretrained_bert_cache)
        model = BertForSeq2SeqDecoder.from_pretrained(args.bert_model, cache_dir=args.pytorch_pretrained_bert_cache, state_dict=model_recover, num_labels=cls_num_labels, num_rel=pair_num_relation, type_vocab_size=type_vocab_size, task_idx=3, mask_word_id=mask_word_id, search_beam_size=args.beam_size,
